...
- 5: **P0 (Critical)** - Cực kỳ quan trọng, ưu tiên hàng đầu
- 4: **P1 (High)** - Quan trọng, cần hoàn thành sớm
- 3: **P2 (Medium)** - Mức trung bình, thực hiện đúng tiến độ
...
| F23 | [App Config](./features/app-config.md)                               | Map Core               |   3    |    3     | ⬜  | ⬜  | ⬜  | ⬜  | ⬜  |   ➖   | ⬜  |
