...
**Mock 1 — Happy Path:**
```json
{ "status": "OK", "request_id": "mock-001",
  "results": [{ "formatted_address": "136 Nguyễn Huệ, Phường Bến Nghé, Quận 1, Hồ Chí Minh, Việt Nam",
...
**Mock 3 — Error:**
```json
{ "status": "INVALID_REQUEST", "error_message": "Parameter 'lat' is out of range [-90, 90].", "request_id": "mock-003" }
```
