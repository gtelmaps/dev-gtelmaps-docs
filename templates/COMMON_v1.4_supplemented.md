...
> **Version:** 1.4
> **Last updated:** 2026-03-09 · Claude (supplemented from v1.3)  
> **Owner:** Platform Team  
> **Kế thừa bởi:**
...
> Bảng hướng dẫn nhanh cho team viết feature spec mới: section nào thường kế thừa nguyên, section nào thường cần override/extend.

| COMMON Section | Inherit | Override | Extend | Ghi chú |
|---|:---:|:---:|:---:|---|
| §2 Auth & Authorization | ✅ | — | — | Chỉ khai báo `permission scope` |
| §3 Rate Limiting & Quota | ✅ | — | — | Kế thừa nguyên |
| §4 Business Rules | ✅ | — | ✅ | Feature thêm BR riêng |
| §5 NFR | ✅ | ✅ | — | Override nếu SLA chặt hơn |
| §6 Response & Error Codes | ✅ | — | ✅ | Feature thêm error code riêng |
| §7 Caching | ✅ | ✅ | — | Override cache key, TTL |
| §8 Logging | ✅ | — | ✅ | Feature thêm log fields riêng |
| §9 Monitoring | ✅ | ✅ | ✅ | Override alert threshold + thêm dashboard panels |
| §10 Security | ✅ | — | — | Kế thừa nguyên |
| §11 DoD | ✅ | — | ✅ | Feature thêm DoD items riêng |

### Feature Spec Template — Cấu trúc khuyến nghị

> Từ FEAT-RG-001 v2.0 trở đi, feature spec khuyến khích dùng cấu trúc 5 Parts:

```text
Part 1 — Bối cảnh:     Overview, Out of Scope, Decisions, Glossary, User Stories, Traceability
Part 2 — Đặc tả:       API Contract (+ BR + AC inline), UI/UX (+ BR + AC inline), NFR, Risks
Part 3 — Vận hành:      Technical Notes, Monitoring, Analytics
Part 4 — Phát hành:     Team Handoff, Testing, DoD, Rollout, Sign-off
Part 5 — Tham khảo:     Open Items, Doc References, Changelog
```

> Nguyên tắc: **AC inline cạnh spec**, không tách thành section riêng. Giúp dev đọc spec + AC một mạch.
...
| 2026-03-09 | 1.4 | Claude | Thêm Typical Override Pattern table, Feature Spec Template (5 Parts structure), khuyến nghị AC inline cạnh spec |
