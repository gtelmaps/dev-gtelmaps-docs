...
| #  | USP                              | Mô tả                                                                                     | So sánh                                              |
| -- | -------------------------------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| 1  | White-label config               | Enterprise thay logo GTEL bằng logo riêng qua config — không cần fork code                | Google Maps bắt buộc hiển thị logo Google            |
| 2  | Responsive variant               | Full logo (desktop) → icon-only (mobile) — tối ưu không gian bản đồ                       | Google Maps logo cố định                             |
| 3  | Click → home reset               | Click logo quay về trạng thái bản đồ mặc định — shortcut quen thuộc                       | Google Maps logo không có chức năng reset             |
