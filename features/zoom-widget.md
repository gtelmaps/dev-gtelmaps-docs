...
| #  | USP                              | Mô tả                                                                                     | So sánh                                              |
| -- | -------------------------------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| 1  | Disable state rõ ràng            | Nút vô hiệu hóa khi đạt min/max zoom — UX feedback tường minh                             | Google Maps tương đương                              |
| 2  | Smooth zoom animation            | Mỗi click zoom một level với animation mượt — nhất quán với pinch-to-zoom                  | Google Maps tương đương                              |
| 3  | Accessibility first              | Keyboard accessible, aria-label rõ ràng — phục vụ người dùng lớn tuổi, khuyết tật          | Google Maps tương đương                              |
