...
| #  | USP                              | Mô tả                                                                                     | So sánh                                              |
| -- | -------------------------------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| 1  | Auto show/hide                   | Ẩn khi heading = 0° (hướng Bắc), hiện khi bản đồ bị xoay — UI clean                      | Google Maps tương đương                              |
| 2  | Click reset hướng Bắc            | Một click quay lại North up — tiện cho 3D view và Navigation mode                         | Google Maps tương đương                              |
| 3  | Kết hợp tilt indicator           | La bàn phản ánh cả heading và tilt — spatial awareness tốt hơn trong 3D                    | Google Maps compass chỉ hiển thị heading             |
